...
void VoxelTypeProperty::setVolume(const VolumeHandleBase* volumeHandle, bool updateRange) {
...
const VolumeHandleBase* VoxelTypeProperty::getVolume() const {
...
void VoxelTypeProperty::updateMinMaxRange() {
    ...
    if (dynamic_cast<const VolumeUInt8*>(volume)  || 
            dynamic_cast<const VolumeUInt16*>(volume) || 
            dynamic_cast<const VolumeUInt32*>(volume) || 
            dynamic_cast<const VolumeInt8*>(volume)   || 
            dynamic_cast<const VolumeInt16*>(volume)  || 
            dynamic_cast<const VolumeInt32*>(volume)  ) {
    ...
    // single-channel float volume
            ...
            dynamic_cast<const VolumeDouble*>(volume) ) {
    ...
    // RGB integer volume
            ...
            dynamic_cast<const Volume3xUInt16*>(volume) || 
            dynamic_cast<const Volume3xInt8*>(volume)   || 
            dynamic_cast<const Volume3xInt16*>(volume)  ) {
    ...
    // RGB float volume
            ...
            dynamic_cast<const Volume3xDouble*>(volume) ) {
