...
TransFuncEditorIntensityRamp::~TransFuncEditorIntensityRamp() {
}

QLayout* TransFuncEditorIntensityRamp::createMappingLayout() {
...
QLayout* TransFuncEditorIntensityRamp::createButtonLayout() {
...
QLayout* TransFuncEditorIntensityRamp::createColorLayout() {
    // Ramp settings
...
void TransFuncEditorIntensityRamp::createWidgets() {
...
void TransFuncEditorIntensityRamp::createConnections() {
    // Buttons
...
void TransFuncEditorIntensityRamp::causeVolumeRenderingRepaint() {
...
void TransFuncEditorIntensityRamp::clearButtonClicked() {
    resetThresholds();
...
void TransFuncEditorIntensityRamp::markerColorChanged(int h, int s, int v) {
    transCanvas_->changeCurrentColor(QColor::fromHsv(h, s, v));
}

void TransFuncEditorIntensityRamp::thresholdChanged(float min, float max) {
...
void TransFuncEditorIntensityRamp::upperThresholdSpinChanged(int value) {
    if (value-1 > 0) {
...
void TransFuncEditorIntensityRamp::updateRampCenter(int center) {
...
void TransFuncEditorIntensityRamp::updateRampWidth(int width) {
...
void TransFuncEditorIntensityRamp::syncRampSliders(int rampCenter, int rampWidth) {
...
void TransFuncEditorIntensityRamp::resetEditor() {
    if (property_->get() != transferFuncIntensity_) {
...
void TransFuncEditorIntensityRamp::setTransFuncProp(TransFuncProperty* prop) {
