...
void VoxelTypePropertyWidget::setVolume(const VolumeHandleBase* volumeHandle) {
...
void VoxelTypePropertyWidget::updateWidgetFromProperty() {
    ...
    const Volume* volume = volumeHandle_->getRepresentation<Volume>();
    if (dynamic_cast<const VolumeUInt8*>(volume) || dynamic_cast<const VolumeInt8*>(volume) || 
        dynamic_cast<const VolumeUInt16*>(volume) || dynamic_cast<const VolumeInt16*>(volume) ||
        dynamic_cast<const VolumeUInt32*>(volume) || dynamic_cast<const VolumeInt32*>(volume) ) {
    ...
    else if (dynamic_cast<const Volume3xUInt8*>(volume) || dynamic_cast<const Volume3xInt8*>(volume) || 
            dynamic_cast<const Volume3xUInt16*>(volume) || dynamic_cast<const Volume3xInt16*>(volume) ) {
    ...
    else if (dynamic_cast<const VolumeFloat*>(volume) || dynamic_cast<const VolumeDouble*>(volume)) {
    ...
    else if (dynamic_cast<const Volume3xFloat*>(volume) || dynamic_cast<const Volume3xDouble*>(volume)) {
