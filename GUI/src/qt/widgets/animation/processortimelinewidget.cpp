...
void ProcessorTimelineWidget::createPropertyTimelineWidget(PropertyTimeline* tl) {
    ...
    else if(dynamic_cast<TemplatePropertyTimeline<VolumeHandle*>*>(tl)) {
...
void ProcessorTimelineWidget::hideTimelines() {
    ...
    if(!hiddenTimelines_)
        hidePropertyTimelines_->setIcon(QIcon(":/icons/expand-plus.png"));
    else
        hidePropertyTimelines_->setIcon(QIcon(":/icons/expand-minus.png"));
