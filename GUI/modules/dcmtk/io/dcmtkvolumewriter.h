...
public:
     ...
     */
    static bool writeDicomFiles(const DcmtkVolumeDescription& desc, const Volume* volume,
...
private:
     ...
     */
    static bool writeDicomFile(const DcmtkVolumeDescription& desc, const Volume* volume,
