...
#include "modules/dcmtk/dcmtkmoduledefine.h"
 ...
 */
class VRN_MODULE_DCMTK_API DcmtkVolumeReader : public VolumeReader {
public:
     ...
     * @return Volume or 0 if an error occured.
     */
    virtual VolumeHandle* read(const std::vector<std::string>& fileNames);
     ...
     * and converts the returned DcmtkSeriesInfos to VolumeOrigins.
     */
...
private:
     ...
     */
    virtual VolumeHandle* readDICOMDIR(const std::string& fileName,
     ...
     */
    virtual VolumeHandle* readDicomFile(const std::string& fileName);
     ...
     */
    virtual VolumeHandle* readDicomFiles(const std::vector<std::string>& fileNames,
                                   const std::string& filterSeriesInstanceUID = "",
