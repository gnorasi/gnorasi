 ...
 */
class VRN_MODULE_PYTHON_API PythonOutputListener {
public:
...
template class VRN_MODULE_PYTHON_API tgt::ResourceManager<PythonScript>;
#endif

class VRN_MODULE_PYTHON_API PythonModule : public VoreenModule, public tgt::ResourceManager<PythonScript> {
