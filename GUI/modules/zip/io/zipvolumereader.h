...
public:
    ZipVolumeReader(ProgressBar* progress = 0);

    virtual std::string getClassName() const    { return "ZipVolumeReader"; }
    virtual std::string getFormatDescription() const  { return "Volumes in ZIP archive"; }
