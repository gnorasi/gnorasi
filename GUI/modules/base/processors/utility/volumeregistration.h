...
private:
    tgt::mat4 computeRigidBodyTransformation(const VolumeHandleBase* inputHandle, const VolumeHandleBase* refHandle,
        tgt::vec3 p0, tgt::vec3 p0ref, tgt::vec3 p1, tgt::vec3 p1ref, tgt::vec3 p2, tgt::vec3 p2ref, bool ignoreReferenceTrafoMatrix);

    tgt::mat4 computeAffineTransformation(const VolumeHandleBase* inputHandle, const VolumeHandleBase* refHandle,
        std::vector<tgt::vec3> inputPoints, std::vector<tgt::vec3> refPoints, bool ignoreReferenceTrafoMatrix);

    tgt::vec3 transformFromVoxelToVolumeCoords(tgt::vec3 point, const VolumeHandleBase* vol);
