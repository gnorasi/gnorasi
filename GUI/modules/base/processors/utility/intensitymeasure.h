...
private:
    ...
    bool measureIntensity(tgt::vec3 samplePos, const VolumeHandleBase* vh, float& intensity, std::string& unit);
    tgt::ivec3 worldToVoxel(tgt::vec3 samplePos, const VolumeHandleBase* vh);
