...
void SingleVolumeRaycaster::process() {
    ...
    if (compositingMode_.isSelected("mida"))
        raycastPrg_->setUniform("gammaValue_", gammaValue_.get());
    
    if (compositingMode1_.isSelected("mida"))
        raycastPrg_->setUniform("gammaValue1_", gammaValue1_.get());
    
    if (compositingMode2_.isSelected("mida"))
        raycastPrg_->setUniform("gammaValue2_", gammaValue2_.get());
