...
void CurvatureRaycaster::initialize() throw (tgt::Exception) {
...
void CurvatureRaycaster::deinitialize() throw (tgt::Exception) {
    portGroup_.deinitialize();

    VolumeRaycaster::deinitialize();
}

void CurvatureRaycaster::compile() {
...
std::string CurvatureRaycaster::generateHeader() {
