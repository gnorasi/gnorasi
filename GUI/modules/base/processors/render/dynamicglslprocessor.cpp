...
void DynamicGLSLProcessor::addNewInport(glslparser::GLSLVariableSymbol* symbol) {
    ...
    if (portType.compare("volumeport") != 0) {
        ...
        default:
            LWARNING("Undefined number of dimensions. Only two allowed");
            break;
        }
    } else {
        ...
        case glslparser::GLSLSymbol::INTERNAL_SAMPLER: {
            // TODO: 2d transfuncs
             if(symbol->getNumInternalElements() == 1) {
                ...
                tfProp->set(new TransFuncIntensity());
                addProperty(tfProp);
            }
            break;
        }
...
void DynamicGLSLProcessor::updatePropertyValues(Property* property, glslparser::GLSLVariableSymbol* symbol) {
    ...
    if (dynamic_cast<BoolProperty*>(property)) {
        ...
        if (value)
            castedProp->set(value->getValueAs<bool>()[0]);
    } else if (dynamic_cast<FloatProperty*>(property)) {
        FloatProperty* castedProp = dynamic_cast<FloatProperty*>(property);
        const glslparser::GLSLAnnotation* value = symbol->getAnnotation("value");
        if (minValue)
            castedProp->setMinValue(minValue->getValueAs<float>()[0]);
        if (maxValue)
            castedProp->setMaxValue(maxValue->getValueAs<float>()[0]);
        if (value)
            castedProp->set(value->getValueAs<float>()[0]);
    } else if (dynamic_cast<FloatVec2Property*>(property)) {
        FloatVec2Property* castedProp = dynamic_cast<FloatVec2Property*>(property);
        if (minValue)
            castedProp->setMinValue(tgt::vec2(minValue->getValueAs<float>()[0], value->getValueAs<float>()[1]));
        if (maxValue)
            castedProp->setMaxValue(tgt::vec2(maxValue->getValueAs<float>()[0], value->getValueAs<float>()[1]));
        if (value)
            castedProp->set(tgt::vec2(value->getValueAs<float>()[0], value->getValueAs<float>()[1]));
    } else if (dynamic_cast<FloatVec3Property*>(property)) {
        FloatVec3Property* castedProp = dynamic_cast<FloatVec3Property*>(property);
        if (minValue)
            castedProp->setMinValue(tgt::vec3(minValue->getValueAs<float>()[0], value->getValueAs<float>()[1], value->getValueAs<float>()[2]));
        if (maxValue)
            castedProp->setMaxValue(tgt::vec3(maxValue->getValueAs<float>()[0], value->getValueAs<float>()[1], value->getValueAs<float>()[2]));
        if (value)
            castedProp->set(tgt::vec3(value->getValueAs<float>()[0], value->getValueAs<float>()[1], value->getValueAs<float>()[2]));
    } else if (dynamic_cast<FloatVec4Property*>(property)) {
        FloatVec4Property* castedProp = dynamic_cast<FloatVec4Property*>(property);
        if (minValue)
            castedProp->setMinValue(tgt::vec4(minValue->getValueAs<float>()[0], value->getValueAs<float>()[1], value->getValueAs<float>()[2], value->getValueAs<float>()[3]));
        if (maxValue)
            castedProp->setMaxValue(tgt::vec4(maxValue->getValueAs<float>()[0], value->getValueAs<float>()[1], value->getValueAs<float>()[2], value->getValueAs<float>()[3]));
        if (value)
            castedProp->set(tgt::vec4(value->getValueAs<float>()[0], value->getValueAs<float>()[1], value->getValueAs<float>()[2], value->getValueAs<float>()[3]));
    } else if (dynamic_cast<IntProperty*>(property)) {
        IntProperty* castedProp = dynamic_cast<IntProperty*>(property);
        if (minValue)
            castedProp->setMinValue(minValue->getValueAs<int>()[0]);
        if (maxValue)
            castedProp->setMaxValue(maxValue->getValueAs<int>()[0]);
        if (value)
            castedProp->set(value->getValueAs<int>()[0]);
    } else if (dynamic_cast<IntVec2Property*>(property)) {
        IntVec2Property* castedProp = dynamic_cast<IntVec2Property*>(property);
        if (minValue)
            castedProp->setMinValue(tgt::ivec2(minValue->getValueAs<int>()[0], value->getValueAs<int>()[1]));
        if (maxValue)
            castedProp->setMaxValue(tgt::ivec2(maxValue->getValueAs<int>()[0], value->getValueAs<int>()[1]));
        if (value)
            castedProp->set(tgt::ivec2(value->getValueAs<int>()[0], value->getValueAs<int>()[1]));
    } else if (dynamic_cast<IntVec3Property*>(property)) {
        IntVec3Property* castedProp = dynamic_cast<IntVec3Property*>(property);
        if (minValue)
            castedProp->setMinValue(tgt::ivec3(minValue->getValueAs<int>()[0], value->getValueAs<int>()[1], value->getValueAs<int>()[2]));
        if (maxValue)
            castedProp->setMaxValue(tgt::ivec3(maxValue->getValueAs<int>()[0], value->getValueAs<int>()[1], value->getValueAs<int>()[2]));
        if (value)
            castedProp->set(tgt::ivec3(value->getValueAs<int>()[0], value->getValueAs<int>()[1], value->getValueAs<int>()[2]));
    } else if (dynamic_cast<IntVec4Property*>(property)) {
        IntVec4Property* castedProp = dynamic_cast<IntVec4Property*>(property);
        if (minValue)
            castedProp->setMinValue(tgt::ivec4(minValue->getValueAs<int>()[0], value->getValueAs<int>()[1], value->getValueAs<int>()[2], value->getValueAs<int>()[3]));
        if (maxValue)
            castedProp->setMaxValue(tgt::ivec4(maxValue->getValueAs<int>()[0], value->getValueAs<int>()[1], value->getValueAs<int>()[2], value->getValueAs<int>()[3]));
        if (value)
            castedProp->set(tgt::ivec4(value->getValueAs<int>()[0], value->getValueAs<int>()[1], value->getValueAs<int>()[2], value->getValueAs<int>()[3]));
    ...
    if (propertyName != "") {
        if (getProperty(propertyName)) {
            ...
            if (dynamic_cast<BoolProperty*>(oldProperty)) {
                ...
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_FLOAT && symbol->getNumInternalElements() == 1)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<FloatVec2Property*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_FLOAT && symbol->getNumInternalElements() == 2)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<FloatVec3Property*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_FLOAT && symbol->getNumInternalElements() == 3)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<FloatVec4Property*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_FLOAT && symbol->getNumInternalElements() == 4)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<IntProperty*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_INT && symbol->getNumInternalElements() == 1)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<IntVec2Property*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_INT && symbol->getNumInternalElements() == 2)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<IntVec3Property*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_INT && symbol->getNumInternalElements() == 3)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<IntVec4Property*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_INT && symbol->getNumInternalElements() == 4)
                    onlyUpdateValues = true;
            }
            else if (dynamic_cast<TransFuncProperty*>(oldProperty)) {
                if (symbol->getInternalType() == glslparser::GLSLSymbol::INTERNAL_SAMPLER && symbol->getNumInternalElements() == 1)
                    onlyUpdateValues = true;
            }
