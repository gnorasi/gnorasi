...
#include "../proxygeometry/cubemeshproxygeometry.h"
...
void VolumeSlicer::setupUniforms(tgt::Shader* slicingPrg) {
    ...
    if(!geometryInport_.isReady() || !(dynamic_cast<CubeMeshProxyGeometry*>(((geometryInport_.getConnected())[0])->getProcessor()))) {
