...
#else
bool Curve3DPolynomial::calcFunction(float /*curveLength*/) {
    LERRORC("voreen.base.LabelingMath", "Curve3DPolynomial requires the JAMA module");
    return false;
}
...
#else
bool Curve2DPolynomial::calcFunction(float /*curveLength*/) {
    LERRORC("voreen.base.LabelingMath", "Curve2DPolynomial requires the JAMA module");
    return false;
}
#endif // VRN_MODULE_JAMA
