...
void VolumeCreate::process() {
    ...
    ivec3 dimensions(dimension_.get());
    ...
    setProgress(1.f);
    VolumeHandle* vh = new VolumeHandle(outputVolume, vec3(1.0f), vec3(0.0f));
    oldVolumePosition(vh);

    outport_.setData(vh);
}

void VolumeCreate::createCornell(const ivec3& dimensions, VolumeUInt8* target) {
    ...
    //white floor
    fillBox(target, ivec3(border, border, border), ivec3(size-border, border+thickness, size-border), white);
    //white back wall:
    fillBox(target, ivec3(border, border, border), ivec3(size-border, size-border, border+thickness), white);
    //white ceiling:
    fillBox(target, ivec3(border, size-border-thickness, border), ivec3(size-border, size-border, size-border), white);
    ...
    fillBox(target,
        ivec3(static_cast<int>(center.x-thickness*2), size-border-thickness, static_cast<int>(center.x-thickness*2)),
        ivec3(static_cast<int>(center.x+thickness*2), size-border, static_cast<int>(center.x+thickness*2)),
        0);

    //green right wall:
    fillBox(target, ivec3(size-thickness-border,thickness+border,thickness+border),
        ivec3(size-border, size-thickness-border, size-border), green);

    //red right wall:
    fillBox(target, ivec3(border, thickness+border, thickness+border),
        ivec3(border+thickness, size-thickness-border, size-border), red);
...
void VolumeCreate::createCube(const ivec3& dimensions, VolumeUInt8* target) {
    vec3 center;
    center = dimensions / 2;
...
void VolumeCreate::createBlobs(const tgt::ivec3& dimensions, VolumeUInt8* target ) {
...
void VolumeCreate::createBlobs2(const ivec3 &dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
...
void VolumeCreate::createBlobs3(const ivec3& dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
...
void VolumeCreate::createSphere(const ivec3& dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
...
void VolumeCreate::createDoubleSphere(const ivec3& dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
...
void VolumeCreate::createTorus(const ivec3& dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
    tgt::vec3 center2 = center;
...
void VolumeCreate::createDoubleTorus(const ivec3& dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
    tgt::vec3 center2 = center;
...
void VolumeCreate::createDoublePartialTorus(const ivec3& dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
    tgt::vec3 center2 = center;
...
void VolumeCreate::createBumpySphere(const ivec3& dimensions, VolumeUInt8* target) {
    tgt::vec3 center = dimensions / 2;
...
void VolumeCreate::createSphereCoord(const ivec3& dimensions, Volume4xUInt8* target) {
...
void VolumeCreate::createSynth(const ivec3& dimensions, VolumeUInt8* target) {
    vec3 center;
    center = dimensions / 2;
...
void VolumeCreate::createCloud(const ivec3& dimensions, VolumeUInt8* target) {
...
void VolumeCreate::createAOTestBox(const ivec3& dimensions, VolumeUInt8* target) {
...
void VolumeCreate::createShadowTestVolume(const ivec3& /*dimensions*/, VolumeUInt8* target) {
...
void VolumeCreate::createAorticArch(const ivec3& dimensions, VolumeUInt8* target) {
    // --------------------
    // ------Settings------
    // --------------------
...
void VolumeCreate::createRandomShapes(const ivec3& dimensions, VolumeUInt8* target) {
    int s = dimensions.x;
    //int thickness = s / 15;
    int thickness = s / 30;
    int border = 3;
...
void VolumeCreate::createDECT(const ivec3& dimensions, VolumeUInt8* target) {
    fillBox(target, ivec3(0,0,0), dimensions, 0);
}

void VolumeCreate::createStack(const tgt::ivec3& dimensions, VolumeUInt8* target) {
    ...
    for (int i = 1; i <= numSubdivisions_.get(); ++i) {
        ...
        fillBox(target, ivec3(0,0,previousHeight), ivec3(dimensions.x, dimensions.y, height), color);
