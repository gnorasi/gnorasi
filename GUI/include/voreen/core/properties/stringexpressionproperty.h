...
public:
     ...
     */
    virtual std::string getPlaceHolder(std::string guiName) const;
     ...
     */
    virtual void addPlaceHolder(std::string guiName, std::string placeholder);
     ...
     */
    virtual bool setPlaceHolderMarkers(std::string beginMarker, std::string endMarker);
     ...
     */
    virtual std::string makePlaceHolder(std::string text) const;
     ...
     */
    virtual std::string getPlaceHolderText(std::string placeholder) const;
     ...
     */
    void clicked(std::string guiName);
     ...
     */
    std::string replacePlaceHoldersInText(std::map<std::string, std::string>) const;
