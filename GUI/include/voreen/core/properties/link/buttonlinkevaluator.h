...
#ifndef VRN_BUTTONLINKEVALUATOR_H
#define VRN_BUTTONLINKEVALUATOR_H
...
class VRN_CORE_API ButtonLinkEvaluator : public LinkEvaluatorBase {
public:
...
#endif // VRN_BUTTONLINKEVALUATOR_H
