...
template <>
VRN_CORE_API std::string InterpolationFunction<VolumeCollection*>::getMode() const;

template <>
VRN_CORE_API std::string InterpolationFunction<VolumeHandle*>::getMode() const;
...
template <>
VRN_CORE_API std::string InterpolationFunction<VolumeCollection*>::getIdentifier() const;

template <>
VRN_CORE_API std::string InterpolationFunction<VolumeHandle*>::getIdentifier() const;
...
template <>
VRN_CORE_API VolumeCollection* InterpolationFunction<VolumeCollection*>::interpolate(VolumeCollection* startvalue, VolumeCollection* endvalue, float time) const;

template <>
VRN_CORE_API VolumeHandle* InterpolationFunction<VolumeHandle*>::interpolate(VolumeHandle* startvalue, VolumeHandle* endvalue, float time) const;
