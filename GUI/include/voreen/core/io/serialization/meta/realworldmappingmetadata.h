...
/// Stores information to map from normalized values (@see Volume::getVoxelFloat) to real world (e.g., HU) values.
...
public:
    ...
    virtual Serializable* create() const { return new RealWorldMappingMetaData(); }
};
