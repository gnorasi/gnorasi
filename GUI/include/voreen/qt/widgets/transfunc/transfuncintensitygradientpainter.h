...
#ifndef VRN_TRANSFUNCINTENSITYGRADIENTPAINTER_H
#define VRN_TRANSFUNCINTENSITYGRADIENTPAINTER_H
 ...
 */
class TransFuncIntensityGradientPainter : public QObject, public tgt::Painter, public tgt::EventListener {
    Q_OBJECT
public:
    /**
     * Constructor
     ...
     */
    TransFuncIntensityGradientPainter(tgt::GLCanvas* canvas);

    /**
     * Destructor
     */
    ~TransFuncIntensityGradientPainter();
...
private:
    ...
    TransFuncIntensityGradient* tf_;        ///< the transfer function that can be edited in this widget
...
#endif // VRN_TRANSFUNCINTENSITYGRADIENTPAINTER_H
