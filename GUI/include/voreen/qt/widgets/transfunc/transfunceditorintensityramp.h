...
/**
 * TransFuncEditorIntensityRamp is an editor widget for an intensity transfer function.
 ...
 */
class TransFuncEditorIntensityRamp : public TransFuncEditor {
    Q_OBJECT
