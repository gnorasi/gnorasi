    ...
    : VoreenModule(moduleName)
{
    ...
    addProcessor(new OTBGrayscaleClosingFilterProcessor());
    ...
    addProcessor(new OTBObjectClassificationToLabelMapProcessor());
    addProcessor(new OTBLabelMapToClassImageProcessor());
