...
#ifndef COMMANDCONTRASTENHANCEMENTLINEARXPERC_H
#define COMMANDCONTRASTENHANCEMENTLINEARXPERC_H
 ...
 */
class CommandContrastEnhancementLinearXPerc : public Command
{
    Q_OBJECT
...
#endif // COMMANDCONTRASTENHANCEMENTLINEARXPERC_H
