...
#ifndef itiotbImageViewManipulatorScrollable_h
#define itiotbImageViewManipulatorScrollable_h
...
public:
  ...
  /** Constructor */
  ImageViewManipulatorScrollable( QObject* parent =NULL );

  /** Destructor */
  virtual ~ImageViewManipulatorScrollable();
...
#endif // itiotbImageViewManipulatorScrollable_h
