...
#include "otbcloudestimatorfilterprocessor.h"
#include "voreen/core/voreenapplication.h"

namespace voreen {

const std::string OTBCloudEstimatorFilterProcessor::loggerCat_("voreen.OTBCloudEstimatorFilterProcessor");

OTBCloudEstimatorFilterProcessor::OTBCloudEstimatorFilterProcessor()
...
Processor* OTBCloudEstimatorFilterProcessor::create() const {
    return new OTBCloudEstimatorFilterProcessor();
}
...
void OTBCloudEstimatorFilterProcessor::initialize() throw (tgt::Exception) {
    Processor::initialize();
}

void OTBCloudEstimatorFilterProcessor::deinitialize() throw (tgt::Exception) {
    Processor::deinitialize();
}

std::string OTBCloudEstimatorFilterProcessor::getProcessorInfo() const {
    return "Cloud Estimator Filter";
}

void OTBCloudEstimatorFilterProcessor::updateBands(int bands) {
...
void OTBCloudEstimatorFilterProcessor::process() {
    ...
    try
    {
        ...
        VectorImage::PixelType pixelRef;
        ...
        LINFO("Cloud Estimator Filter Connected!");

    }
    catch (int e)
    {
        LERROR("Error in Cloud Estimator Filter");
        return;
    }
