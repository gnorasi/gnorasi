...
#include "otbgrayscaledilatefilterprocessor.h"
#include "voreen/core/voreenapplication.h"


namespace voreen {
const std::string OTBGrayscaleDilateFilterProcessor::loggerCat_("voreen.OTBGrayscaleDilateFilterProcessor");
...
void OTBGrayscaleDilateFilterProcessor::initialize() throw (tgt::Exception) {

    Processor::initialize();
}

void OTBGrayscaleDilateFilterProcessor::deinitialize() throw (tgt::Exception) {

    Processor::deinitialize();
}

std::string OTBGrayscaleDilateFilterProcessor::getProcessorInfo() const {
    
    return "Grayscale Dilation Filtering Processor";
}

void OTBGrayscaleDilateFilterProcessor::process() {
    ...
    {
	LERROR("Problem with Grayscale Dilation Image Filter!");
	return;
    }
