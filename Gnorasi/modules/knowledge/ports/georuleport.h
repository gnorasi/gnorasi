...
#ifndef VRN_GEORULEPORT_H
#define VRN_GEORULEPORT_H
...
class GeoRulePort : public Port {
public:
    explicit GeoRulePort(PortDirection direction, const std::string& name,
    ...
    std::vector<const GeoRulePort* > getConnected() const;
